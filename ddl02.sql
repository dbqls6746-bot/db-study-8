...
insert into new_table3
values(1, null, to_date('2020-01-02'));    -- null 이라는 값을 지정해서 저장
...
무결성( db 가장 기본 내용 : 중복X + NOT NULL ) : 데이터 올바르게, 일관되게, 유지
    ...
    > 신뢰성 : 데이터에 대한 믿음 신뢰
            ...
            신발 구매 제고 확인 1개 -> 창고에 가지러 갔더니 0개         X
...
values (4,syssdate);          -- name NOT NULL  저장 XXX
...
NUMBER(6, 3) : 전체자리수 6자리, 소수점 3자리
                123.456 O       10.551O     1234.560 X  <-NUMBER(7,3)
