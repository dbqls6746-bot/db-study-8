...
PK(기본키) 용으로 사용허간 순차적인 데이터를 표현하기위해 사용하는 숫자 값
...
select seq_seq_test_psk.currval from dual;   --현재 시퀀스값 확인
...
--이 다음이 다시 nextval 다음 값을 호출했을때 1이 나오도록 만들기!
